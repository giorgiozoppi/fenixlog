...
if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
  ...
  # using GCC
  target_compile_options(unit_test PRIVATE -Wall -Wextra -Werror -std=c++20 -fconcepts -Wall -Wextra -Werror -O0 -ggdb -fprofile-arcs -ftest-coverage)
  target_link_libraries(unit_test PRIVATE ${Boost_LIBRARIES} ${YAMLCPP_LIBRARY} crypto ssl pthread spdlog::spdlog spdlog::spdlog_header_only) 
